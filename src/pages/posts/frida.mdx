...
Often the TLS negotation fails for Android applications when you try to intercept the HTTP(S) traffic. A capture trace can give you a good indication of certificate pinning is in place. 
